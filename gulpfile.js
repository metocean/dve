...
var autoprefixer, browserify, buffer, coffee, concat, errorify, gulp, gutil, livereload, merge, minifycss, npmpackage, rename, replace, source, sourcemaps, stylus, uglify, watchify;
...
gulp.task('style', function() {
  var css, styl;
  styl = gulp.src('style/dve.styl').pipe(sourcemaps.init()).pipe(stylus());
  css = gulp.src('node_modules/colorbrewer/colorbrewer.css').pipe(sourcemaps.init());
  return merge(css, styl).pipe(concat(npmpackage.name + "-" + npmpackage.version + ".min.css")).pipe(autoprefixer({
